...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8722433709:AAHqwpiCEobbTCP1CtnFFHg621PuRPiTgBU")
CHANNEL_USERNAME = os.environ.get("CHANNEL_USERNAME", "@xpromp")   # jo channel join karna zaroori hai
CHANNEL_INVITE_LINK = os.environ.get("CHANNEL_INVITE_LINK", "https://t.me/xpromp")
